...
API_KEY = "UcoumzghSbbI-FY08l9_Ah0S5gyYw3U06h-GWRzluLkm"
...
def predict():
    ...
    response_scoring = requests.post('https://us-south.ml.cloud.ibm.com/ml/v4/deployments/841f760f-0da5-44cb-9a5e-26fff4a6c712/predictions?version=2022-06-04', json=payload_scoring,
    ...
    if (output == 0):
        return render_template('chance.html', prediction='You have a liver desease problem.')
    elif (output == 1):
